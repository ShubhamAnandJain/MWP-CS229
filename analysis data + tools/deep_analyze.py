...
for i in range(int(len(lines)/5)):
  ...
  if 1:
    ...
    number_vals = lines[5 * i].count('NUM')
    ...
    bag_of_words = lines[5 * i]
    # bag_of_words = lines[5*i].split(' ')
    
    type_1 = "How many more"
    type_2 = "How much more"
    type_3 = "How many"
    type_4 = "How much"

    # type_1 = ["How", "many", "more"]
    if(contains(type_1, bag_of_words) or contains(type_2, bag_of_words)):
      how_many_more += 1
      # print(lines[5 * i])
    elif(contains(type_3, bag_of_words) or contains(type_4, bag_of_words)):
      how_many += 1
